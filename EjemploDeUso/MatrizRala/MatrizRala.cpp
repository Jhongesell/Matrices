...
void MatrizRala::solicitaMemoria(const int ren, const int col)
{
   //~ int i, j;
   //~ M = new ldouble *[ren];
...
void MatrizRala::liberaMemoria(void)
{
   //~ int i;
   //~ if (M)
   //~ {
...
// @param col Columna
// @param val Valor
void MatrizRala::asigna(const int ren, const int col, const ldouble val)
{
...
// @param col Columna
// @return Valor
ldouble MatrizRala::retorna(const int ren, const int col)
{
   if (ren < 0 || ren >= Ren || col < 0 || col >= Col)
   {
...
void MatrizRala::copia(Matriz *a)
{
   //~ int i, j;
   //~ for (i = 0; i < Ren; i++)
   //~ {
...
// @param esc Escalar
void MatrizRala::multiplica(ldouble esc)
{
   //~ int i, j;
...
//~ void MatrizRala::multiplica(MatrizRala *a, MatrizRala *b)
//~ {
//~ #ifdef DEPURAR
...
void MatrizRala::multiplica(Vector *b, Vector *r)
{
//~ #ifdef DEPURAR
